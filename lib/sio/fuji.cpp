...
// Reset esp1541
void sioFuji::sio_reset_esp1541()
{
...
char *_generate_appkey_filename(appkey *info)
{
    ...
    snprintf(filenamebuf, sizeof(filenamebuf), "/esp1541/%04hx%02hhx%02hhx.key", info->creator, info->app, info->key);
    return filenamebuf;
}
...
void sioFuji::sio_write_app_key()
{
    ...
    // Make sure we have a "/esp1541" directory, since that's where we're putting these files
    fnSDFAT.create_path("/esp1541");
...
void sioFuji::sio_get_adapter_config()
{
    ...
    strlcpy(cfg.fn_version, fnSystem.get_fw_version(true), sizeof(cfg.fn_version));
