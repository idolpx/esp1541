...
void WD177x::Write(unsigned int address, unsigned char value)
{
	...
	switch (address & 3)
	{
		case COMMAND:
		{
			...
			{
				Debug_printf("Command rejected BUSY\n");
			}
			else
			{
				// Type I Commands
