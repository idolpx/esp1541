...
uint32_t IEC_Bus::oldClears = 0;
uint32_t IEC_Bus::oldSets = 0;
uint32_t IEC_Bus::PIGPIO_MASK_IN_ATN = 1 << PIGPIO_ATN;
uint32_t IEC_Bus::PIGPIO_MASK_IN_DATA = 1 << PIGPIO_DATA;
uint32_t IEC_Bus::PIGPIO_MASK_IN_CLOCK = 1 << PIGPIO_CLOCK;
uint32_t IEC_Bus::PIGPIO_MASK_IN_SRQ = 1 << PIGPIO_SRQ;
uint32_t IEC_Bus::PIGPIO_MASK_IN_RESET = 1 << PIGPIO_RESET;
...
uint32_t IEC_Bus::myOutsGPFSEL1 = 0;
uint32_t IEC_Bus::myOutsGPFSEL0 = 0;
bool IEC_Bus::InputButton[5] = { 0 };
bool IEC_Bus::InputButtonPrev[5] = { 0 };
uint32_t IEC_Bus::validInputCount[5] = { 0 };
uint32_t IEC_Bus::inputRepeatThreshold[5];
uint32_t IEC_Bus::inputRepeat[5] = { 0 };
uint32_t IEC_Bus::inputRepeatPrev[5] = { 0 };


uint32_t IEC_Bus::emulationModeCheckButtonIndex = 0;
