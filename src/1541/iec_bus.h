...
//static const uint32_t PI_OUTPUT_MASK_GPFSEL1 = ~((1 << 21) | (1 << 24));
// 000 001 001 001 000 000 001 000 000 000	(bits 21 and 24 for GPIO 17 and 18 as outputs)
//static const uint32_t PI_OUTPUT_MASK_GPFSEL1 = ~((1 << ((PIGPIO_OUT_SOUND - 10) * 3)) | (1 << ((PIGPIO_OUT_LED - 10) * 3)) | (1 << ((PIGPIO_CLOCK - 10) * 3)) | (1 << ((PIGPIO_DATA - 10) * 3)));
static const uint32_t PI_OUTPUT_MASK_GPFSEL1 = ~((1 << ((PIGPIO_CLOCK - 10) * 3)) | (1 << ((PIGPIO_DATA - 10) * 3)));
///////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	static void WaitMicroSeconds(uint32_t amount)
	{
		uint32_t count;
...
private:
	static uint32_t oldClears;
	static uint32_t oldSets;
	...
	static uint32_t PIGPIO_MASK_IN_ATN;
	static uint32_t PIGPIO_MASK_IN_DATA;
	static uint32_t PIGPIO_MASK_IN_CLOCK;
	static uint32_t PIGPIO_MASK_IN_SRQ;
	static uint32_t PIGPIO_MASK_IN_RESET;

	static uint32_t emulationModeCheckButtonIndex;
	...
	static uint32_t myOutsGPFSEL0;
	static uint32_t myOutsGPFSEL1;
	static bool InputButton[5];
	static bool InputButtonPrev[5];
	static uint32_t validInputCount[5];
	static uint32_t inputRepeatThreshold[5];
	static uint32_t inputRepeat[5];
	static uint32_t inputRepeatPrev[5];
